...
const Project = ({ name }) => {
  return (
    <div className="relative py-6 px-6 h-56 rounded-lg shadow-md bg-white border-l-8 border-amber-400">
      ...
      <div className="flex justify-end gap-6 absolute bottom-8 right-6">
